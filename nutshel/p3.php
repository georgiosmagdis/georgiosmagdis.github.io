				...
				<!-- Banner -->
					<section id="banner" class="major">
						<div class="inner"  style="background: transparent;">
							<header class="major">
								<h1>My Science in a Nutshell</h1>
							</header>
				...
				<!-- Main -->
					...
					<section>
						<div class="inner">
							...
							<p>They say that for great discoveries we need to be prepared for the unexpected. But first we need to engage with the unknown, and this is a key aspect of my research.</p>
